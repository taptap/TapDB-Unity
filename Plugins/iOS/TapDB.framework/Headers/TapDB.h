...
#define TapDBSDK_VERSION_NUMBER @"33001001"
#define TapDBSDK_VERSION        @"3.30.1"
//版本号
...
/// 获取 TapAid（回调可能不在主线程）
+ (void)requestTapAidWithCompletionHandler:(void (^)(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error))completionHandler;

/// 获取 TapAid 归因结果（回调可能不在主线程）
+ (void)requestTapAidAttributionWithCompletionHandler:(void (^)(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error))completionHandler;

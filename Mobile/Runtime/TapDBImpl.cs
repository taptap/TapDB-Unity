...
namespace TapTap.TapDB.Mobile
{
    public class TapDBImpl : ITapDB
    {
        ...
        private void HandleIDFA() {
            ...
            if(TapCommon.Config != null && TapCommon.Config.DBConfig != null){
                enableIDFA = TapCommon.Config.DBConfig.AdvertiserIDCollectionEnabled;
            } 
